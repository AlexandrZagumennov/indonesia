...
const calc = () => {
  ...
  const dateListForm = document.querySelector('.form__date-list'); // Функция открытия списка дат
...
/* harmony import */ var _form_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(590);
...
(0,_form_js__WEBPACK_IMPORTED_MODULE_5__/* .form */ .c)();
