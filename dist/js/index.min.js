...
/* harmony export */   "P": function() { return /* binding */ acc; }
/* harmony export */ });
// Аккордеон
const acc = () => {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "y": function() { return /* binding */ calc; }
/* harmony export */ });
// Калькулятор
const calc = () => {
  // Исходные данные 
  ...
  const totalCostBtn = document.querySelector('#total-cost'); // Функция создания элементов списка месяцев
  ...
  const changeContentItem = event => {
    ...
    dateDatesItem.forEach(j => {
      ...
      j.classList.remove('calc__date-dates-item_active'); // Если атрибут элемента месяца совпадает с атрибутом месяца, то элемент показывается
  ...
  const dateDatesItem = document.querySelectorAll('.calc__date-dates-item'); //Устанавливается начальный активный элемент. Февраль.
  ...
  const showCheckedInputs = () => {
    ...
    optionsValue.textContent = checkedOptions; // Если пользователь удалил все ранее выбранные опции
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": function() { return /* binding */ choices; }
/* harmony export */ });
const choices = () => {
...
const form = () => {
  ...
  const allInputs = [...selects, ...inputs]; // Обратотка события HOVER
...
/* harmony import */ var _burger_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(384);
/* harmony import */ var _sliders_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(248);
/* harmony import */ var _acc_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(482);
/* harmony import */ var _calc_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(907);
/* harmony import */ var _choices_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(812);
/* harmony import */ var _scroll_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(43);
/* harmony import */ var _form_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(590);
...
(0,_burger_js__WEBPACK_IMPORTED_MODULE_0__/* .burger */ .e)();
(0,_sliders_js__WEBPACK_IMPORTED_MODULE_1__/* .swipers */ .B)();
(0,_acc_js__WEBPACK_IMPORTED_MODULE_2__/* .acc */ .P)();
(0,_calc_js__WEBPACK_IMPORTED_MODULE_3__/* .calc */ .y)();
(0,_choices_js__WEBPACK_IMPORTED_MODULE_4__/* .choices */ .Z)();
(0,_scroll_js__WEBPACK_IMPORTED_MODULE_5__/* .scroll */ .A)();
(0,_form_js__WEBPACK_IMPORTED_MODULE_6__/* .form */ .c)();
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "B": function() { return /* binding */ swipers; }
/* harmony export */ });
const swipers = () => {
